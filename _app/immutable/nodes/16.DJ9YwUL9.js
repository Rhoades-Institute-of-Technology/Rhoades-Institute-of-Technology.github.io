import{s as u,n as s,d as i,b as g,i as c,m as n,o as y,c as d,g as m,p as f,h,j as v}from"../chunks/BPBcIdQy.js";import{S as w,i as b}from"../chunks/iFfmbG1G.js";function R(p){let e,r,t,l=`<div class="max-w-3xl mx-auto prose prose-invert prose-indigo"><h1>Privacy Policy</h1> <p class="text-sm text-rit-text-muted">Last updated: March 28, 2026</p> <h2 id="who-we-are">Who We Are</h2> <p>This website is operated by
			...
			Johnathon Rhoades / The Rhoades Institute of Technology.</p> <h2 id="what-we-collect">What We Collect</h2> <p>We collect almost nothing. Here is the complete list:</p> <ul><li><strong>Contact form submissions:</strong> Your name, email address, and message, submitted
					voluntarily through our contact form. Submissions are sent directly to our email via a
					Cloudflare Worker — no third-party form service stores your data. Only we receive it.
			...
			We do not sell, rent, or share your data with anyone beyond what is described here.</p> <ul><li><strong>Stripe</strong> — Processes donations. PCI-DSS compliant. See their
				<a href="https://stripe.com/privacy">privacy policy</a>.</li> <li><strong>Cloudflare Workers + D1</strong> — Processes and stores contact form and
					waitlist/survey submissions. Data is stored in Cloudflare D1 (SQLite at the edge)
					and a notification is sent to our email. Retained for 90 days after inquiry resolved.
					See Cloudflare&#39;s <a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noopener noreferrer">privacy policy</a>.</li> <li><strong>GitHub Pages</strong> — Hosts this website. GitHub may log standard web server
			...
			changes will be communicated via email to those who have provided their contact information.</p> <h2 id="contact">Contact</h2> <p>Johnathon Rhoades / The Rhoades Institute of Technology<br/> <a href="mailto:rit.ptaa@gmail.com">rit.ptaa@gmail.com</a></p></div>`;return{c(){e=h("meta"),r=v(),t=h("section"),t.innerHTML=l,this.h()},l(o){const a=y("svelte-ho16ta",document.head);e=d(a,"META",{name:!0,content:!0}),a.forEach(i),r=m(o),t=d(o,"SECTION",{class:!0,"data-svelte-h":!0}),f(t)!=="svelte-vjo00t"&&(t.innerHTML=l),this.h()},h(){document.title="Privacy Policy | RIT",n(e,"name","description"),n(e,"content","Rhoades Institute of Technology privacy policy. We collect almost nothing and tell you exactly what."),n(t,"class","py-12 px-4")},m(o,a){g(document.head,e),c(o,r,a),c(o,t,a)},p:s,i:s,o:s,d(o){o&&(i(r),i(t)),i(e)}}}class k extends w{constructor(e){super(),b(this,e,null,R,u,{})}}export{k as component};
